...
@section('content')
    ...
    <div class="untree_co-section product-section before-footer-section">
        <div class="container">
            @if ($bengkels->isEmpty())
                <p class="text-center">Tidak ada bengkel yang sesuai dengan kriteria yang diinginkan</p>
            @else
                <div class="row row-cols-1 row-cols-md-3 g-4 bengkel">
                    @foreach ($bengkels as $bengkel)
                        <div class="col-12 col-md-4 col-lg-3 mb-5">
                            <a class="product-item" href="/detailbengkelpage/{{ $bengkel->id }}">
                                <img src="{{ asset('images/' . $bengkel->image) }}"
                                    class="img-fluid product-thumbnail w-100" style="height: 280px; object-fit: cover">
