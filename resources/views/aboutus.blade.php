        ...
        <div class="container">
            <div class="row justify-content-center mb-4">
                <div class="col-md-7 text-center">
                    ...
                    <h6 class="subtitle fs-6">Kelompok 4 yang paling kompak, Meng eak?. Mata Kuliah Pemrograman Web Lanjut
                    </h6>
                </div>
            </div>
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <img src="{{ asset('css/fardi.jpg') }}" alt="wrapkit" class="img-fluid rounded-circle"
                                style="object-fit: cover; width: 360px; height: 345px;" />
                        </div>
                        <div class="col-md-12 text-center">
                            <div class="pt-2">
                                <h5 class="mt-4 font-weight-medium mb-0">Fardi</h5>
                                <h6 class="subtitle mb-3">All Role</h6>
                                <p>Jangan lupa tidur</p>
                                <ul class="list-inline">
                                    <li class="list-inline-item"><a href="#"
                                            class="text-decoration-none d-block px-1"><i
                                                class="icon-social-facebook"></i></a></li>
